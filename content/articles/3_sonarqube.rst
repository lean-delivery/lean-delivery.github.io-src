...
Каждый языковой плагин предоставляет свой Built-in профиль – это просто набор включенных и выключенных правил, в соответсвии с которыми проверяется код.
...
Следующий шаг – настройка Quality Gates. Это набор метрик, в соответсвии с которыми проверка кода будет считаться успешной или не успешной. Дефолтный набор (пример)
